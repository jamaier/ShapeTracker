...
namespace ShapeTracker
{
  class Program
  {
    static void Main()
    {
      ...
      Console.WriteLine("We'll calculate what type of shape you have based off of the lengths provided.");
    ...
    {
      Console.WriteLine("Please confirm that you entered in your shape correctly:");
      ...
      Console.WriteLine("Is that correct? Enter 'yes' to proceed, or 'no' to re-enter the shapes sides");
      ...
      {
        Console.WriteLine("Let's fix your triangle. Please enter the sides again!");
        Console.WriteLine("Please enter a number:");
        string stringNumber1 = Console.ReadLine();  
        Console.WriteLine("Enter another number:");
        string stringNumber2 = Console.ReadLine();  
